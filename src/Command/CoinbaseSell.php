 ...
 */
class CoinbaseSell extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setName('coinbase:sell')
            
            
            ->addArgument('amount', InputArgument::REQUIRED, 'Amount?')
            ->addArgument('cyproprice', InputArgument::REQUIRED, 'cyproprice at?')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $cyproprice = $input->getArgument('cyproprice');
